...
if __name__ == '__main__':
    ...
    question = "We are a student engineering team designing a vehicle for the FSAE competition. Attached is the FSAE rules document. List all the rules that relate to the suspension. Answer only with the rules numbers."
